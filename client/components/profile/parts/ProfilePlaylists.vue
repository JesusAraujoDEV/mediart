  ...
  <div class="w-full flex flex-col gap-3">
    ...
    <div class="flex items-center justify-between">
      ...
      <button
        ...
        :aria-label="'Crear playlist desde cero'"
        :title="'Crear playlist desde cero'"
    ...
    <Teleport to="body">
      <transition name="fade" appear>
        <div
          ...
          aria-modal="true"
          role="dialog"
          aria-labelledby="createPlaylistTitle"
        >
          ...
          >
              ...
              <div class="flex flex-col md:flex-row md:items-center gap-3">
                <div class="relative flex-1">
                  <input
                    ...
                    placeholder="Buscar ítems (canciones, álbumes, artistas, podcasts)"
                ...
                <div class="flex flex-wrap items-center gap-2">
                  <select v-model="filters.type" class="rounded bg-gray-700/70 border border-gray-600 px-2 py-2 text-sm">
                  ...
                  <select v-model="filters.genre" class="rounded bg-gray-700/70 border border-gray-600 px-2 py-2 text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="h-64 overflow-auto space-y-2">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-2">
                      <button
                        class="text-xs rounded bg-purple-600 hover:bg-purple-700 px-2 py-1"
                        @click="addPending(it)"
                      >
                        Agregar
                      </button>
              ...
              <div class="rounded border border-white/10 p-2">
                <div class="flex items-center justify-between mb-2">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      class="text-xs rounded bg-gray-600 hover:bg-gray-700 px-2 py-1"
                      @click="clearPendingList"
                ...
                <div class="h-64 overflow-auto space-y-2">
                  ...
                  >
                    ...
                    <div class="flex items-center gap-2">
                      <button class="text-xs rounded bg-gray-600 hover:bg-gray-700 px-2 py-1" @click="removePending(idx)">
                        Quitar
                      </button>
                    </div>
                  </div>
            ...
            <div class="mt-4 flex justify-end gap-3">
              ...
              <button
                class="rounded-full bg-purple-600 px-4 py-2 text-white hover:bg-purple-700 disabled:opacity-50"
