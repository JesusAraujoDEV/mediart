<template>
  <div class="flex flex-col items-center gap-3 sm:gap-5 w-full">
    <div class="relative">
      <img 
        :src="resolvedSrc" 
        @error="handleImageError" 
        :alt="loading ? 'Cargando perfil...' : 'Profile'"
        class="size-40 sm:size-40 md:size-44 rounded-full object-cover border-4 border-white/20 shadow-xl hover:border-white/40 transition-all duration-300" 
      />
